...
import edgeLutscher from "./edges/lutscher";
import edgeLutscherRoundabout1 from "./edges/lutscher-roundabout-1";
import edgeLutscherRoundabout2 from "./edges/lutscher-roundabout-2";
import edgeLutscherRoundabout3 from "./edges/lutscher-roundabout-3";
import edgeRoundabout1 from "./edges/roundabout-1";
import edgeRoundabout2 from "./edges/roundabout-2";
import edgeRoundabout3 from "./edges/roundabout-3";
import edgeRing from "./edges/ring";
