...
import edgeVentoux from "./edges/ventoux";
import edgeOutside from "./edges/outside";
import edgeMiddle from "./edges/middle";
import edgePetitKOM from "./edges/petit-kom";
import edgeHarborPaddock from "./edges/harbor-paddock";
import edgeVentouxBottom from "./edges/ventoux-bottom";
import edgeVentouxBottom1 from "./edges/ventoux-bottom-1";
import edgeVentouxBottom2 from "./edges/ventoux-bottom-2";
import edgeVentouxBottom3 from "./edges/ventoux-bottom-3";
import edgeHarbor1 from "./edges/harbor-1";
import edgeHarbor2 from "./edges/harbor-2";
import edgeHarbor3 from "./edges/harbor-3";
import edgePetitKOM1 from "./edges/petit-kom-1";
import edgePetitKOM2 from "./edges/petit-kom-2";
import edgePetitKOM3 from "./edges/petit-kom-3";
import edgeVentoux1 from "./edges/ventoux-top-1";
import edgeVentoux2 from "./edges/ventoux-top-2";
import edgeVentoux3 from "./edges/ventoux-top-3";
import edgeVentoux4 from "./edges/ventoux-top-4";
