...
ROADS.createEdge(PADDOCK_ROW_FRONT, PADDOCK_SPLIT, [], false);
...
ROADS.createEdge(PADDOCK_SPLIT, PADDOCK_EXIT_EAST, [], false);
ROADS.createEdge(PADDOCK_SPLIT, PADDOCK_EXIT_WEST, [], false);
...
const CITY_ROUNDABOUT_2 = ROADS.createNode([51.50733, -0.126726, 23.3]);
