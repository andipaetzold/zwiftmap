...
// Urukazi - Paddock
const URUKAZI_PADDOCK_EXIT = ROADS.createNode([-10.795194, 165.812544, 4.8]);
const URUKAZI_PADDOCK_ROW_FRONT = ROADS.createNode([
  -10.794525, 165.813257, 4.8,
]);
const URUKAZI_PADDOCK_ROW_BACK = ROADS.createNode([
  -10.794011, 165.813815, 4.8,
]);
const URUKAZI_PADDOCK_CENTER = ROADS.createNode([-10.793187, 165.814671, 4.8]);
const URUKAZI_PADDOCK_1 = ROADS.createNode([-10.794572, 165.814462, 4.8]);
const URUKAZI_PADDOCK_2 = ROADS.createNode([-10.793297, 165.813244, 4.8]);
const URUKAZI_PADDOCK_3 = ROADS.createNode([-10.794109, 165.814961, 4.8]);
const URUKAZI_PADDOCK_4 = ROADS.createNode([-10.792839, 165.813738, 4.8]);
ROADS.createEdge(URUKAZI_PADDOCK_CENTER, URUKAZI_PADDOCK_ROW_BACK, [], false);
ROADS.createEdge(
  URUKAZI_PADDOCK_ROW_BACK,
  URUKAZI_PADDOCK_ROW_FRONT,
  [],
  false
);
ROADS.createEdge(URUKAZI_PADDOCK_ROW_FRONT, URUKAZI_PADDOCK_EXIT, [], false);
ROADS.createEdge(URUKAZI_PADDOCK_1, URUKAZI_PADDOCK_ROW_FRONT, [], false);
ROADS.createEdge(URUKAZI_PADDOCK_2, URUKAZI_PADDOCK_ROW_FRONT, [], false);
ROADS.createEdge(URUKAZI_PADDOCK_3, URUKAZI_PADDOCK_ROW_BACK, [], false);
ROADS.createEdge(URUKAZI_PADDOCK_4, URUKAZI_PADDOCK_ROW_BACK, [], false);

// Urukazi - North Isle
const URUKAZI_NORTH_ISLE_WEST_1 = ROADS.createNode([
...
ROADS.createEdge(URUKAZI_NORTH_ISLE_WEST_1, URUKAZI_NORTH_ISLE_WEST_2, []);
ROADS.createEdge(URUKAZI_NORTH_ISLE_WEST_2, URUKAZI_NORTH_ISLE_WEST_3, []);
ROADS.createEdge(URUKAZI_NORTH_ISLE_WEST_3, URUKAZI_NORTH_ISLE_WEST_1, []);

const URUKAZI_NORTH_ISLE_EAST_1 = ROADS.createNode([-10.79574, 165.816543, 5]);
const URUKAZI_NORTH_ISLE_EAST_2 = ROADS.createNode([-10.795916, 165.816801, 5]);
const URUKAZI_NORTH_ISLE_EAST_3 = ROADS.createNode([-10.796039, 165.816683, 5]);
ROADS.createEdge(URUKAZI_NORTH_ISLE_EAST_1, URUKAZI_NORTH_ISLE_EAST_2, []);
ROADS.createEdge(URUKAZI_NORTH_ISLE_EAST_2, URUKAZI_NORTH_ISLE_EAST_3, []);
ROADS.createEdge(URUKAZI_NORTH_ISLE_EAST_3, URUKAZI_NORTH_ISLE_EAST_1, []);
...
// Urukazi - South Isle
const URUKAZI_SOUTH_ISLE_WEST_1 = ROADS.createNode([-10.808799, 165.816103, 0]);
const URUKAZI_SOUTH_ISLE_WEST_2 = ROADS.createNode([-10.808613, 165.81646, 0]);
const URUKAZI_SOUTH_ISLE_WEST_3 = ROADS.createNode([-10.80906, 165.816392, 0]);
ROADS.createEdge(URUKAZI_SOUTH_ISLE_WEST_1, URUKAZI_SOUTH_ISLE_WEST_2, []);
ROADS.createEdge(URUKAZI_SOUTH_ISLE_WEST_2, URUKAZI_SOUTH_ISLE_WEST_3, []);
ROADS.createEdge(URUKAZI_SOUTH_ISLE_WEST_3, URUKAZI_SOUTH_ISLE_WEST_1, []);

const URUKAZI_SOUTH_ISLE_EAST_1 = ROADS.createNode([-10.806481, 165.820268, 0]);
const URUKAZI_SOUTH_ISLE_EAST_2 = ROADS.createNode([-10.806727, 165.820572, 0]);
const URUKAZI_SOUTH_ISLE_EAST_3 = ROADS.createNode([-10.806847, 165.820291, 0]);
ROADS.createEdge(URUKAZI_SOUTH_ISLE_EAST_1, URUKAZI_SOUTH_ISLE_EAST_2, []);
ROADS.createEdge(URUKAZI_SOUTH_ISLE_EAST_2, URUKAZI_SOUTH_ISLE_EAST_3, []);
ROADS.createEdge(URUKAZI_SOUTH_ISLE_EAST_3, URUKAZI_SOUTH_ISLE_EAST_1, []);
