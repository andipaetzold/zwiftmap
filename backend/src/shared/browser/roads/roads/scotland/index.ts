...
import edgeWestToSummit from "./edges/country-west-to-summit";
...
import edgeSgurrSummitEast2 from "./edges/sgurr-summit-east-2";
import edgeSgurrSummitEast3 from "./edges/sgurr-summit-east-3";
import edgeSgurrSummitWest1 from "./edges/sgurr-summit-west-1";
import edgeSgurrSummitWest2 from "./edges/sgurr-summit-west-2";
import edgeSgurrSummitWest3 from "./edges/sgurr-summit-west-3";
...
createEdge(PADDOCK_WEST_EXIT, PADDOCK_WEST_FRONT_1, []);
