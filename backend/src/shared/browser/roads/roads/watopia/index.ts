...
const THE_GRADE_TOP1 = createNode([-11.693941, 166.96676, 13.8]);
const THE_GRADE_TOP2 = createNode([-11.693371, 166.966768, 13.8]);
const THE_GRADE_TOP3 = createNode([-11.693187, 166.966695, 13.8]);
const THE_GRADE_TOP4 = createNode([-11.69295, 166.966642, 321.2]);
const THE_GRADE_TOP5 = createNode([-11.69301, 166.967242, 317.6]);
