...
declare module "@turf/helpers" {
  ...
  export declare type Lines =
    ...
    | Polygon
    | MultiPolygon;
  export declare type AllGeoJSON =
    | Feature
    | FeatureCollection
    | Geometry
    | GeometryCollection;
   ...
   * //=feature
   */
  export declare function feature<G = Geometry, P = Properties>(
    geom: G,
    properties?: P,
    options?: {
      bbox?: BBox;
   ...
   * // => geometry
   */
  export declare function geometry(
    type:
      | "Point"
      | "LineString"
      | "Polygon"
   ...
   * //=point
   */
  export declare function point<P = Properties>(
   ...
   * //=points
   */
  export declare function points<P = Properties>(
    coordinates: Position[],
    properties?: P,
    options?: {
      bbox?: BBox;
   ...
   * //=polygons
   */
  export declare function polygons<P = Properties>(
    coordinates: Position[][][],
    properties?: P,
    options?: {
      bbox?: BBox;
   ...
   * //=linestring2
   */
  export declare function lineString<P = Properties>(
    coordinates: Position[],
    properties?: P,
    options?: {
      bbox?: BBox;
   ...
   * //=linestrings
   */
  export declare function lineStrings<P = Properties>(
    coordinates: Position[][],
    properties?: P,
    options?: {
      bbox?: BBox;
   ...
   * //=collection
   */
  export declare function featureCollection<G = Geometry, P = Properties>(
   ...
   * //=multiLine
   */
  export declare function multiLineString<P = Properties>(
    coordinates: Position[][],
    properties?: P,
    options?: {
      bbox?: BBox;
   ...
   * //=multiPt
   */
  export declare function multiPoint<P = Properties>(
    coordinates: Position[],
    properties?: P,
    options?: {
      bbox?: BBox;
   ...
   *
   */
  export declare function multiPolygon<P = Properties>(
    coordinates: Position[][][],
    properties?: P,
    options?: {
      bbox?: BBox;
   ...
   * // => collection
   */
  export declare function geometryCollection<P = Properties>(
    geometries: Array<
      Point | LineString | Polygon | MultiPoint | MultiLineString | MultiPolygon
    >,
    properties?: P,
   ...
   */
  export declare function radiansToLength(
    radians: number,
    units?: Units
  ): number;
  /**
   ...
   */
  export declare function lengthToRadians(
    distance: number,
    units?: Units
  ): number;
  /**
   ...
   */
  export declare function lengthToDegrees(
    distance: number,
    units?: Units
  ): number;
  /**
   ...
   */
  export declare function convertArea(
    area: number,
    originalUnit?: Units,
    finalUnit?: Units
  ): number;
